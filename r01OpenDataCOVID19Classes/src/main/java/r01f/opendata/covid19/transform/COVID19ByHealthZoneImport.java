...
/////////////////////////////////////////////////////////////////////////////////////////
	public static Url getByHealthZoneFileUrlAt(final Date date) {
		Url url = Url.from(Strings.customized("https://opendata.euskadi.eus/contenidos/ds_informes_estudios/covid_19_2020/opendata/0320/24/osasun_eremuak-zonas_salud-{}.csv",
	...
	public static COVID19ByHealthZoneAtDate importByHealthZoneFrom(final Url url) throws IOException {
		// read the file
